...
I've translated the content and organized it into a table format suitable for Excel (copy-paste into a spreadsheet). Columns include:
- **Category**: Main section (e.g., Heating).
- **Item/Subitem**: Specific component or detail.
- **Lifespan (Years)**: Expected duration.
- **Price Type**: e.g., Replacement, New Coat.
- **Price (CHF)**: Indicative cost.
- **Unit**: e.g., per m², per piece.
- **Notes**: Additional details, e.g., kU or reductions.

For special usages (e.g., offices, shops), reduce lifespans by 20-50% (especially for floors/walls/ceilings). The table covers pages 3-12 of the document.
